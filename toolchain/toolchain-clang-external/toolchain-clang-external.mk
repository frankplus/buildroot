...
# It supports toolchains with no binary prefix, using BR2_TOOLCHAIN_CLANG_EXTERNAL
...
TOOLCHAIN_CLANG_EXTERNAL_TOOLCHAIN_WRAPPER_ARGS += \
...
TOOLCHAIN_CLANG_EXTERNAL_INSTALL_STAGING = YES
TOOLCHAIN_CLANG_EXTERNAL_ADD_TOOLCHAIN_DEPENDENCY = NO

define TOOLCHAIN_CLANG_EXTERNAL_BUILD_CMDS
	$(TOOLCHAIN_WRAPPER_BUILD)
endef

define TOOLCHAIN_CLANG_EXTERNAL_INSTALL_STAGING_CMDS
...
define TOOLCHAIN_CLANG_EXTERNAL_INSTALL_TARGET_CMDS
